...
<html lang="en">
    ...
    <body>
        ...
        <header class="masthead" style="background-image: url('{{ url_for('static', filename='img/post-inquinamento.jpg') }}">
            <div class="container position-relative px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h2>%titolo_post%</h2>
                            <span class="subheading"><i>%sottotitolo_post%</i></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row gx-2 gx-lg-3 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <ul class="list-inline text-center">
                            ...
                            <li class="list-inline-item">
                                <a href="https://github.com/ABAJAJA/TDP_Progetto">
                                    <span class="fa-stack fa-lg">
                                        <i class="fas fa-circle fa-stack-2x"></i>
